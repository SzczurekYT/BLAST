...
public class NavalMineEntity extends BombEntity {
    ...
    protected CustomExplosion getExplosion() {
        return new CustomExplosion(this.world, this.getOwner(), this.getX(), this.getY(), this.getZ(), 4f, CustomExplosion.BlockBreakEffect.AQUATIC, Explosion.DestructionType.DESTROY);
